...
export default defineConfig({
  extends: defineTeekConfig({
    ...
    social: [
      { name: "GitHub", icon: "github", link: "https://github.com/Sunday9787" },
    ],
    // 文章摘要 & 封面配置
    post: {
      showCapture: true,
    ...
    banner: {
      ...
      description: "人生有振作奋斗的时刻，也有必须接受现实的时候。现在木已成舟，只有傻子才会去钻牛角尖。但事实上，我一直都是个傻子。",
      descStyle: "types",
      mask: true,
    },
    // 右侧卡片
    homeCardSort: ["topArticle", "category", "tag", "friendLink"],
    topArticle: { limit: 5 },
    category: { limit: 8 },
    tag: { limit: 21 },
    friendLink: {
  ...
  themeConfig: {
    nav: [
      ...
      { text: "存档", link: "/article/", activeMatch: "^/article/$" },
    ...
    sidebar: {
      "/log/": [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: "target=_blank", link: "/log/security/target=_blank" },
          ],
        },
        {
          text: "开发规范",
          collapsed: true,
          items: [
            { text: "代码规范", link: "/log/specification/code-style" },
          ],
        },
        {
          text: "Vscode",
          collapsed: true,
          items: [
            { text: "ESLint + Prettier + Stylelint + Commitlint", link: "/log/vscode/eslint-prettier-stylelint-commitlint" },
        ...
        },
        {
          ...
          items: [
            ...
            { text: "模板编辑器组件", link: "/log/vue/template_editor_component" },
            { text: "模板编辑器控制", link: "/log/vue/template_editor_control" },
            { text: "模板编辑器指南", link: "/log/vue/template_editor_guide" },
            { text: "模板编辑器标线", link: "/log/vue/template_editor_markline" },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: "Webpack + TS + ES6 + Vue", link: "/log/webpack/webpack-ts-es6-vue" },
          ],
        },
        {
          text: "Devops",
          collapsed: true,
          items: [
            { text: "阿里云 Pipeline 构建失败", link: "/log/devops/aliyun-pipeline-pnpm-build-failure" },
          ],
        },
      ],
    },
